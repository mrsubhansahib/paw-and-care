                    ...
                    <div class="col-12">
                        <div class="shop-top-bar">
                            <div class="shop-top-left">
                                <p class="pagination-line"><a href="<?php echo e(asset('#')); ?>">12</a> Product Found of <a
                                        href="<?php echo e(asset('#')); ?>">30</a></p>
                            </div>
                                ...
                                <div class="banner-product-single-style2-item">
                                    <div class="thumb">
                                        <a href="<?php echo e(asset('#')); ?>">
                                            <img src="<?php echo e(asset('web/assets/img/shop/banner/3')); ?>.webp" width="870"
                                    ...
                                    <div class="content">
                                        ...
                                        <a class="btn-theme-link" href="<?php echo e(asset('#')); ?>">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/2.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Endeavor
                                                                Daytripa</a></h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/3.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Impulse Duffle</a>
                                                        </h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/4.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Driven Backpack</a>
                                                        </h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/6.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Savvy Shoulder
                                                                Tote</a></h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/7.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Voyage Yoga Bag</a>
                                                        </h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/8.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Wayfarer Messenger
                                                                Bag</a></h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/1.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Joust Duffle Bag</a>
                                                        </h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/5.webp')); ?>" width="270"
                                                                height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                                                        <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Fusion Backpack</a>
                                                        </h4>
                                                        <div class="prices">
                                            ...
                                            <div class="col-12">
                                                <div class="pagination-items pagination-items-style1">
                                                    <ul class="pagination mb--0">
                                                        <li><a class="active" href="<?php echo e(asset('#')); ?>">1</a></li>
                                                        <li><a href="shop-four-columns.html">2</a></li>
                                                        <li><a href="shop-three-columns.html">3</a></li>
                                                        <li><a href="<?php echo e(asset('#')); ?>" class="icon"><i
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-1.webp')); ?>"
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-2.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-info">
                                                                <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Impulse
                                                                        Duffle</a></h4>
                                                                <div class="prices">
                                                                    <span class="price">$65.00</span>
                                                                </div>
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-3.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-info">
                                                                <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Driven
                                                                        Backpack</a></h4>
                                                                <div class="prices">
                                                                    <span class="price">$25.00</span>
                                                                </div>
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-4.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-info">
                                                                <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Savvy
                                                                        Shoulder Tote</a></h4>
                                                                <div class="prices">
                                                                    <span class="price">$30.00</span>
                                                                </div>
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-5.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-info">
                                                                <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Voyage Yoga
                                                                        Bag</a></h4>
                                                                <div class="prices">
                                                                    <span class="price">$39.00</span>
                                                                </div>
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-6.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product-info">
                                                                <h4 class="title"><a href="<?php echo e(route('single-product')); ?>">Wayfarer
                                                                        Messenger Bag</a></h4>
                                                                <div class="prices">
                                                                    <span class="price">$50.00</span>
                                                                </div>
                                                ...
                                                <div class="product-item product-list-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="product-thumb">
                                                                <a href="<?php echo e(route('single-product')); ?>">
                                                                    <img src="<?php echo e(asset('web/assets/img/shop/col2-8.webp')); ?>"
                                                                        width="420" height="320" alt="Image-HasTech">
                                                                </a>
                                                                <div class="product-action">
                                                                    <button type="button" class="btn-product-wishlist"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xl-6">
                                                ...
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        <a href="<?php echo e(route('single-product')); ?>">
                                                            <img src="<?php echo e(asset('web/assets/img/shop/col2-7.webp')); ?>"
                                                                width="420" height="320" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                    <div class="product-info">
                            ...
                            <div class="shop-widget shop-sidebar-category">
                                ...
                                <div class="sidebar-category">
                                    <ul class="category-list mb--0">
                                        <li><a href="<?php echo e(asset('#')); ?>">Accesasories <span>(5)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Computer <span>(4)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Covid-19 <span>(2)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Electronics <span>(6)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Frame Sunglasses <span>(12)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Furniture <span>(7)</span></a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Genuine Leather <span>(9)</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="shop-widget shop-sidebar-tags">
                                ...
                                <div class="sidebar-tags">
                                    <ul class="tags-list mb--0">
                                        <li><a href="<?php echo e(asset('#')); ?>">Fashion</a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Organic</a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Old Fashion</a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Men</a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Fashion</a></li>
                                        <li><a href="<?php echo e(asset('#')); ?>">Dress</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="product-action-view-content">
                        ...
                        <div class="modal-action-product">
                            ...
                            <h4 class="product-name"><a href="<?php echo e(route('single-product')); ?>">Joust Duffle Bag</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <nav id="offcanvasNav" class="offcanvas-menu-nav">
                <ul>
                    <li class="offcanvas-nav-parent">
                        ...
                        <ul>
                            <li><a href="<?php echo e(asset('#')); ?>"><span>Home One</span></a></li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('single-product')); ?>"><span>Single Product Variable</span></a></li>
...
<?php echo $__env->make('layouts.web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\personal\paw-and-care\resources\views/layouts/web/shop/index.blade.php ENDPATH**/ ?>