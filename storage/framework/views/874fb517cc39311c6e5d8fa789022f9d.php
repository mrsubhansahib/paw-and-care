<footer class="footer-area">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="widget-item widget-about">
                ...
                <div class="social-icons">
                  ...
                  <a href="" target="_blank" rel="noopener"><i class="fa fa-dribbble"></i></a>
          ...
          <div class="row">
            <div class="col-12">
              <div class="footer-bottom-content">
                ...
                <div class="payment">
                  <a href="account.html"><img src="<?php echo e(asset('web/assets/img/photos/payment.webp')); ?>" width="192" height="21"
                      alt="Payment Logo"></a>
                </div>
              </div>
            </div>
      ...
      <!--== End Footer Bottom ==-->
    </footer><?php /**PATH C:\laragon\www\personal\paw-and-care\resources\views/layouts/web/footer.blade.php ENDPATH**/ ?>