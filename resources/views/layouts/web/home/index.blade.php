...
@section('content')
            ...
            <div class="swiper home-slider-container default-slider-container">
                <div class="swiper-wrapper home-slider-wrapper slider-default">
                    <div class="swiper-slide">
                        ...
                        <div class="slider-content-area" data-bg-img="{{ asset('web/assets/img/slider/slider-bg.webp') }}">
                            <div class="container">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-sm-6 col-md-6">
                                            <div class="slider-content">
                                                <div class="content">
                                                    ...
                                                    <div class="btn-box">
                                                        <a class="btn-theme text-dark" href="{{ route('shop') }}">Shop Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="slider-thumb mousemove">
                                                <div class="thumb">
                                                    <img src="{{ asset('web/assets/img/slider/slider-01.webp') }}"
            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-gutter-43">
                    <div class="col">
                        ...
                        <div class="product-category-item">
                            <div class="thumb">
                                ...
                                <a href="#"><img src="{{ asset('web/assets/img/shop/category/1.webp') }}" width="200"
                    ...
                    <div class="col">
                        ...
                        <div class="product-category-item">
                            <div class="thumb">
                                ...
                                <a href="#"><img src="{{ asset('web/assets/img/shop/category/2.webp') }}" width="200"
                                        height="200" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        ...
                        <div class="product-category-item">
                            <div class="thumb">
                                ...
                                <a href="#"><img src="{{ asset('web/assets/img/shop/category/3.webp') }}" width="200"
                                        height="200" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        ...
                        <div class="product-category-item">
                            <div class="thumb">
                                ...
                                <a href="#"><img src="{{ asset('web/assets/img/shop/category/4.webp') }}" width="200"
                                        height="200" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        ...
                        <div class="product-category-item">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('web/assets/img/shop/category/5.webp') }}" width="200"
                                        height="200" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-6">
                        <div class="banner-product-single-item">
                            ...
                            <div class="content">
                                ...
                                <a class="btn-theme btn-theme-color btn-sm" href="{{ route('shop') }}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row isotope-grid">
                    <div class="col-sm-6 col-lg-3 isotope-item filter_best_sellers filter_on_sall">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/1.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_new filter_featured">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/2.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_best_sellers filter_on_sall">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/3.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_new filter_featured">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/4.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_best_sellers filter_on_sall">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/5.webp') }}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_new filter_featured">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/6.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_best_sellers filter_on_sall">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/7.webp') }}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-sm-6 col-lg-3 isotope-item filter_new filter_featured">
                        ...
                        <div class="product-item">
                            <div class="product-thumb">
                                <a href="#">
                                    <img src="{{ asset('web/assets/img/shop/8.webp')}}" width="270" height="320"
                                        alt="Image-HasTech">
                                </a>
                            </div>
                            <div class="product-info">
                ...
                <div class="row divider-style1">
                    <div class="col-lg-3 col-xl-4">
                        <div class="divider-thumb divider-thumb-left">
                            <img src="{{ asset('web/assets/img/photos/divider1.webp')}}" width="351" height="435"
                                alt="Image-HasTech">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="divider-content text-center">
                            ...
                            <a class="btn-theme text-dark" href="{{ route('shop') }}">Shop Now</a>
                            <img class="shape-object" src="{{ asset('web/assets/img/shape/object1.webp')}}" width="316"
                                height="302" alt="Image-HasTech">
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-4">
                        <div class="divider-thumb divider-thumb-right">
                            <img src="{{ asset('web/assets/img/photos/divider2.webp')}}" width="488" height="447"
                                alt="Image-HasTech">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="product-item daily-product-item">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-thumb">
                                        <a href="#">
                                            <img src="{{ asset('web/assets/img/shop/9.webp')}}" width="270" height="320"
                                                alt="Image-HasTech">
                                        </a>
                                        <div class="product-action">
                                            <button type="button" class="btn-product-wishlist" data-bs-toggle="modal"
                        ...
                        <div class="product-item daily-product-item">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-thumb">
                                        <a href="#">
                                            <img src="{{ asset('web/assets/img/shop/10.webp')}}" width="270" height="320"
                                                alt="Image-HasTech">
                                        </a>
                                        <div class="product-action">
                                            <button type="button" class="btn-product-wishlist" data-bs-toggle="modal"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="about-thumb">
                                <img src="{{ asset('web/assets/img/about/1.webp')}}" width="569" height="577"
                                    alt="Image-HasTech">
                            </div>
                        </div>
                    </div>
    ...
    <aside class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1" id="AsideOffcanvasCart"
        ...
        <div class="offcanvas-body">
            ...
            <a class="d-block text-end lh-1" href="{{ route('checkout') }}"><img src="assets/img/photos/paypal.webp" width="133"
