                                    ...
                                    <tbody>
                                            ...
                                            <td class="product-thumbnail">
                                                <div class="thumb">
                                                    <a href="single-product.html">
                                                        <img src="{{ asset('web/assets/img/shop/product-mini/cart1.webp') }}" width="75"
                                        ...
                                        <tr class="tbody-item">
                                            ...
                                            <td class="product-thumbnail">
                                                <div class="thumb">
                                                    <a href="single-product.html">
                                                        <img src="{{ asset('web/assets/img/shop/product-mini/cart2.webp') }}" width="75"
                                                            height="75" alt="Image-HasTech">
                                                    </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="tbody-item">
                                            ...
                                            <td class="product-thumbnail">
                                                <div class="thumb">
                                                    <a href="single-product.html">
                                                        <img src="{{ asset('web/assets/img/shop/product-mini/cart3.webp') }}" width="75"
                                                            height="75" alt="Image-HasTech">
                                                    </a>
                                                </div>
                                            </td>
